  ...
  return (
    <div className={styles.modalOverlay}>
      <div className={styles.modalContent}>
        ...
        <h2>{t('sales.title') || 'Industrial Scale Support'}</h2>
        <p>{t('sales.message') || 'Projects exceeding 50 units require coordinated logistics. Our Tesla Energy Sales team will contact you to finalize the design.'}</p>
        
        <form onSubmit={handleSubmit} className={styles.form}>
          <Input 
            type="email" 
            placeholder={t('sales.email') || 'Email Address'} 
            value={email}
          ...
          <Input 
            type="tel" 
            placeholder={t('sales.phone') || 'Phone Number'} 
            value={phone}
